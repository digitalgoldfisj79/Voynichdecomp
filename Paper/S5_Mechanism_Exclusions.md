...
- Grille generators cannot produce the autocorrelation signal (AC ≈ 0 vs VMS +0.160)
...
The narrow gap between structural ceiling (88%) and self-consistency ceiling (86%) suggests the generator has reached or slightly exceeded the manuscript's own internal consistency, defining the available space for genuine content encoding. The information budget's 71.1% unexplained entropy is the upper bound on content; the remaining gap between generator performance and perfect reproduction reflects structure-independent variation.
