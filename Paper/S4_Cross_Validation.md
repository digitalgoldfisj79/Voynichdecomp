# S4: Cross-Validation, Red Team, and Robustness Checks
...
## S4.1 PGCS Grammar Cross-Validation
...
## S4.2 Red Team Analysis (9 Attacks)
...
- **ROBUST** (T1+T2, 435 quads, 77.6% tokens): Corruption-validated. Short slots, high counts, absorbs noise.
