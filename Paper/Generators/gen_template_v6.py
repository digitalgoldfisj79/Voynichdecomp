...
def main():
    print("=" * 70)
    print("GENERATOR 13: + GALLOWS CO-OCCURRENCE")
    print("=" * 70)
    print("""
    ...
    with open('results/template_v6_corpora.pkl', 'wb') as f:
    ...
    print("-" * 40)
    rows = [
        ('+COOCCUR', s15['n_pass'], s85['n_pass']),
        ('Gen 12 (always-chg)', 12, 70),
    ...
    with open('results/template_v6_scores.pkl', 'wb') as f:
        pickle.dump({
    ...
    print(f"\nSaved results/template_v6_scores.pkl")
