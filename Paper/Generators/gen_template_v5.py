...
def main():
    print("=" * 70)
    print("GENERATOR 12: ALWAYS-CHANGE + MINIMAL PRESERVATION")
    print("=" * 70)
    print("""
    CORRECTED RULES + MINIMAL FORM PRESERVATION:
      ...
      D) Rule 3: ALWAYS change one other slot (was 50%)
    """)
    ...
    with open('results/template_v5_corpora.pkl', 'wb') as f:
    ...
    print("-" * 40)
    rows = [
        ('ALWAYS-CHG', s15['n_pass'], s85['n_pass']),
        ('Gen 11 (50% chg)', 12, 70),
    ...
    with open('results/template_v5_scores.pkl', 'wb') as f:
        pickle.dump({
    ...
    print(f"\nSaved results/template_v5_scores.pkl")
