...
def build_spec(p70c_path='data/p70c_full_spec_v1.json',
    ...
    # ROUNDED LINE-START WEIGHTS: 20-20-15-15-10-10-5-5
    # Original: o=22.5, ∅=21.7, d=14.3, y=13.4, qo=10.3, s=9.3, sh=4.4, ch=4.2
    # Max delta: 2.5pp. Pattern a scribe can remember as four pairs.
    spec['transitions']['LINE_START'] = {
        'o': 20, '∅': 20, 'd': 15, 'y': 15,
        'qo': 10, 's': 10, 'sh': 5, 'ch': 5
    }
...
def main():
    print("=" * 70)
    print("GENERATOR 14: ROUNDED LINE-START WEIGHTS")
    print("=" * 70)
    print("""
    ...
    with open('results/template_v7_corpora.pkl', 'wb') as f:
    ...
    with open('results/template_v7_scores.pkl', 'wb') as f:
        pickle.dump({
    ...
    print(f"\nSaved results/template_v7_scores.pkl")
