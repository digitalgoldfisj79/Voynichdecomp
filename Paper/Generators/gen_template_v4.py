...
def main():
    print("=" * 70)
    print("GENERATOR 11: TMPL+DUCTUS+SFX+MINIMAL PRESERVATION")
    print("=" * 70)
    print("""
    CORRECTED RULES + MINIMAL FORM PRESERVATION:
      ...
      D) Minimal forms: if ∅G+∅C, Rule 3 only changes prefix
    """)
    ...
    with open('results/template_v4_corpora.pkl', 'wb') as f:
    ...
    print("-" * 40)
    rows = [
        ('TMPL+D+SFX+MIN', s15['n_pass'], s85['n_pass']),
        ('Tmpl+Duct+Sfx', 12, 70),
    ...
    with open('results/template_v4_scores.pkl', 'wb') as f:
        pickle.dump({
    ...
    print(f"\nSaved results/template_v4_scores.pkl")
