...
def main():
    ...
    ap=argparse.ArgumentParser();ap.add_argument('root');ap.add_argument('--out',default='RESULTS_cantus_boundary_formulaicity_v0_1.json');args=ap.parse_args();p=find_chant_csv(args.root);by=defaultdict(list);rows=vol=eligible=0;parsefail=0
