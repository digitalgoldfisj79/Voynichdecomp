...
import joint_semimarkov_v043 as joint
...
def main() -> None:
    ...
    language, model = load_language(args.repo, f"svt-v043-{args.mode}-{args.replicate}")
    ...
    # Truth is evaluation-only below this line.
    ...
    payload = {
        "programme": "SVT-v0.4.3",
        "stage": "length_comparable_joint_semimarkov",
        "binding": True,
        ...
        "initial_units": int(solved["initial_units"]),
        ...
        "canonical_language_gain": float(canonical["language_gain"]),
        "canonical_surface_score": float(canonical["surface_score"]),
        "canonical_complexity_penalty": float(canonical["complexity_penalty"]),
    }
