...
strong_acc=b['map_acc'](H['freq'],strong,true)
q3_score=b['score_num'](S,fit,comp)
true_score=b['score_num'](S,true,comp)
out={
 'reproduction':{'attempt':attempt,'mapping_acc':acc,'fit_agreement':agr,'true_score':true_score,'q3_fit_score':q3_score},
 'd1':{'strong_score':ss,'strong_restart':strong_rr,'strong_acc':strong_acc,'strong_vs_q3':ss-q3_score,'true_vs_q3':true_score-q3_score,'true_vs_strong':true_score-ss,'classification':'OPTIMIZER MISS' if (strong_acc>=0.999999 or ss-q3_score>=1e-5) else 'NO MATERIAL OPTIMIZER MISS'},
