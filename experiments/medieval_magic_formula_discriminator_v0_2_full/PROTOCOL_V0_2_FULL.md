...
For each qualified external metric, compute Voynich standardized location relative to heldout A, B and C distributions at each R0–R3 layer. Also compute nearest-centroid Mahalanobis/ridge-Euclidean distance in externally standardized qualified metric space.
